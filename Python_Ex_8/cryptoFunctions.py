...
def blocksFreqAnalysis(text):
    """
    This function perform a frequency analysis of the given text for 
    every possible couple of characters.
    ...
    for i in range(26):
        for j in range(26):
            s = string.ascii_uppercase[i] + string.ascii_uppercase[j]
            freq[j + 26*i] = text.count(s)/L*100
